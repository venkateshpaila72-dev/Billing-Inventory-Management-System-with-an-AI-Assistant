...
export const getRevenue = (period = "daily") => api.get(`/analytics/revenue?period=${period}`).then(r => r.data);
...
export const getProfit = (period = "daily") => api.get(`/analytics/profit?period=${period}`).then(r => r.data);